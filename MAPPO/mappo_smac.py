...
writer = SummaryWriter("./tf-logs2/loss_250_2")####loss函数的储存地址
...
class MAPPO_SMAC:
    ...
    def choose_action(self, obs_n, avail_a_n, evaluate):
        with torch.no_grad():
            ...
            obs_n = np.array(obs_n)  # 先将列表转换为numpy数组
    ...
    def train(self, replay_buffer, total_steps):
        ...
        # avail_a_n = torch.ones(1, 94)
        # writer.add_graph(self.actor, (example_input, avail_a_n))
        ...
        writer.add_scalar('loss',ac_loss,total_steps)
        writer.close()
